#' prscore: calculate representative score of samples
#'
#' @param dist_matrix dist matrix generated by VCF2Dis
#' @param sample_matrix sample matrix with 2 lines (sampleid and populations)
#'
#' @return score
#' @export
#'
